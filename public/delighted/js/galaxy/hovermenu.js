...
$(function(){
	$.hovermenu('init',{
		buttons:{
			"tl":{icon:"fa fa-power-off", text:"Dashboard", callback: function(){window.open("/#dashboard"); }},
			"tr":{icon:"fa fa-file-text", text:"Production", callback: function(){ window.open('/#production') }},
			"bl":{icon:"fa fa-male", text:"Orders", callback: function(){window.open("/#orders"); }},
			"br":{icon:"fa fa-envelope", text:"Search", callback: function(){$(".nav-input-search").focus();}}
		}
	});
