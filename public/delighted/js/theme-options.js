$(document).ready(function(){
	...
	if(localStorage.getItem('primaryCol')){
		applyLess();
		less.modifyVars({

			'@primary':localStorage.getItem('primaryCol'),
			'@leftSidebarBackground':localStorage.getItem('secondaryCol'),
			'@leftSidebarLinkColor':localStorage.getItem('linkCol')
	...
	$('.predefined-themes li a').click(function(){
		...
		localStorage.setItem('primaryCol', primaryCol);
		localStorage.setItem('secondaryCol', secondaryCol);
		localStorage.setItem('linkCol', linkCol);
