...
@section('content')
	...
	<div class="col-md-3 col-sm-12">
		...
		<div class="btn-group">
				<button id="addOrder" data-toggle="modal" data-target="addOrderModal" type="button" class="btn btn-primary btn-sm"><i class=" fa fa-plus"></i> Order</button>
		</div>
		<div id="external-events">
				...
				<h5 class="event-form-title">Metro</h5>
				<hr class="visible-xs"/>
				...
				<h5 class="event-form-title">Outbound</h5>
				<hr class="visible-xs"/>
				...
				<h5 class="event-form-title">Shipping</h5>
				<hr class="visible-xs"/>
				...
				<h5 class="event-form-title">Pickup</h5>
				<hr class="visible-xs"/>
