			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat green">
							...
							<a href="{{ URL::to('pmethods/create') }}" class="more">
							Add Pmethod <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="well">
						...
						<p>{{ link_to_route('pmethods.create', 'Add new pmethod') }}</p>
