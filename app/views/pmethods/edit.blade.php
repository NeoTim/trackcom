			...
			<div class="row">
				<div class='col-md-12'>
					<div class='well'>
						...
						<h1>Edit Pmethod</h1>
						{{ Form::model($pmethod, array('method' => 'PATCH', 'route' => array('pmethods.update', $pmethod->id))) }}
							<ul>
								...
								<li>
									...
									{{ link_to_route('pmethods.show', 'Cancel', $pmethod->id, array('class' => 'btn')) }}
								</li>
							</ul>
						{{ Form::close() }}
