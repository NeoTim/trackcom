			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat yellow">
							...
							<a href="{{ URL::to('sub_cats') }}" class="more">
							View sub_cats <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
			...
			<div class="row">
				<div class='col-md-12'>
					<div class='well'>
						...
						<h1>Edit Sub_cat</h1>
						{{ Form::model($sub_cat, array('method' => 'PATCH', 'route' => array('sub_cats.update', $sub_cat->id))) }}
							<ul>
            ...
            <div class="col-md-9">
                {{ Form::checkbox('visible', null, array('class' => 'form-control')) }}
								...
								<li>
									...
									{{ link_to_route('sub_cats.show', 'Cancel', $sub_cat->id, array('class' => 'btn')) }}
								</li>
							</ul>
						{{ Form::close() }}
