			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat yellow">
							...
							<a href="{{ URL::to('dtypes') }}" class="more">
							View dtypes <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
			...
			<div class="row">
				<div class='col-md-12'>
					<div class='well'>
						...
						<h1>Edit Dtype</h1>
						{{ Form::model($dtype, array('method' => 'PATCH', 'route' => array('dtypes.update', $dtype->id))) }}
							<ul>
            ...
            <div class="col-md-9">
                {{ Form::text('name', null, array('class' => 'form-control')) }}
								...
								<li>
									...
									{{ link_to_route('dtypes.show', 'Cancel', $dtype->id, array('class' => 'btn')) }}
								</li>
							</ul>
						{{ Form::close() }}
