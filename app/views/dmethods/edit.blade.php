...
@section('main')
	<div class="page-content-wrapper">
			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat yellow">
							...
							<a href="{{ URL::to('dmethods') }}" class="more">
							View dmethods <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
			...
			<div class="row">
				<div class='col-md-12'>
					<div class='well'>
						...
						<h1>Edit Dmethod</h1>
						{{ Form::model($dmethod, array('method' => 'PATCH', 'route' => array('dmethods.update', $dmethod->id))) }}
							<ul>
        ...
        <div class="form-group">
            {{ Form::label('dtype_id', 'Dtype_id:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
                {{ Form::input('number', 'dtype_id', null, array('class' => 'form-control')) }}
            </div>
        </div>
            ...
            <div class="col-md-9">
                {{ Form::textarea('desc', null, array('class' => 'form-control')) }}
								...
								<li>
									...
									{{ link_to_route('dmethods.show', 'Cancel', $dmethod->id, array('class' => 'btn')) }}
								</li>
							</ul>
						{{ Form::close() }}
