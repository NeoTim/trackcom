...
@section('main')
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat blue">
							...
							View Trucks <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
            ...
            {{ Form::label('driver', 'Driver:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
        ...
        <div class="form-group">
            {{ Form::label('orders', 'Orders:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
                {{ Form::input('number', 'orders', null, array('class' => 'form-control')) }}
            </div>
        </div>
