...
@section('main')
	<div class="page-content-wrapper">
			...
			<div class="row">
				<div class='col-md-12'>
						...
						<div class="dashboard-stat yellow">
							...
							<a href="{{ URL::to('documents') }}" class="more">
							View documents <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			</div>
        ...
        <div class="form-group">
            {{ Form::label('product_id', 'Product_id:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
                {{ Form::input('number', 'product_id', null, array('class' => 'form-control')) }}
            </div>
        </div>

        <div class="form-group">
            {{ Form::label('path', 'Path:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
