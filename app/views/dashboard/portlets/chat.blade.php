<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="{{ asset('assets/img/avatar1.jpg') }}"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="{{ asset('assets/img/avatar2.jpg') }}"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="{{ asset('assets/img/avatar3.jpg') }}"/>
										<div class="message">
											<span class="arrow">
											</span>
