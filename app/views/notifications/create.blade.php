...
@section('main')
	<div class="page-content-wrapper">
		<div class="page-content">
            ...
            {{ Form::label('user_id', 'User_id:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
        ...
        <div class="form-group">
            {{ Form::label('subject', 'Subject:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
        ...
        <div class="form-group">
            {{ Form::label('active', 'Active:', ['class' => 'control-label col-md-3']) }}
            <div class="col-md-9">
